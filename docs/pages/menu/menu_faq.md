...
> {: .warn }
Should the motor be wired incorrectly, **you could damage it**.
...
[M913 - Set Hybrid Threshold Speed](https://marlinfw.org/docs/gcode/M913.html)  
[M569 - Set TMC stepping mode](https://marlinfw.org/docs/gcode/M569.html)
...
Good question.  
There are a few highlights such as EP2 grease, or something like a gun oil. There are a few great videos out there that should help you make your decision.
...
Depending on which you decide on, may draw upwards of **5 amps**. In which case, **22AWG** wire is recommended based on a chart.

#### Heated bed

Your heated bed should be  **at least 16AWG**, and if upgraded, you should again reference a chart for larger wire and amperage needed.
